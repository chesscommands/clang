...
[BASEPlate] = LAYOUT_ergodox(  // layer 0 : default
		...
		LT(MOUSEPlate, KC_ENTER),	KC_A,	KC_S,	KC_D,	KC_F,	KC_G,			/* 6桁	*/
		SFT_T(KC_BSPACE),	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_MINUS,		/* 7桁	*/
		KC_GRAVE,	KC_QUOTE,	KC_LALT,	KC_SPACE,	KC_LCTRL,					/* 5桁	*/
																/* 親指部分	*/
																TO(TEMSPlate),	KC_ESCAPE,			/* 2桁	*/
																			KC_LBRACKET,					/* 1桁	*/
																LT(MOUSEPlate, KC_ESCAPE),	KC_LALT,		/* 2桁	*/
																			KC_ENTER,						/* 1桁	*/

        // right hand
		KC_BSPACE,	KC_6,	KC_7,	KC_8,	KC_9,	KC_0,	OSM(MOD_LSFT),										/* 7桁	*/
...
/* Keymap : WindowsBasic 日本語配列用のベースレイヤ
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
